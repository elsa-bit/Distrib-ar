...
import 'package:distribar/ancien_projet/utils/custom_views/item_card_noAlcoholic.dart';
...
class _SpecialCategoryState extends State<SpecialCategory> {
  ...
  void initState() {
    super.initState();
    futureCocktail = ViewModelCocktail.fetchSpecialCategory(widget.title) as Future<DataClassTableCocktail>;
    futureNoAlcoholic = ViewModelCocktail.fetchNoAlcoholicCocktail() as Future<DataClassTableCocktail>;
  }
